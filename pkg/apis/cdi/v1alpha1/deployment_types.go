...
func (mode *DeviceMode) Set(value string) error {
	if value == string(DeviceModeFPGA) || value == string(DeviceModeGPU) {
...
const (
	// DeviceModeFPGA represents 'fpga' device manager
	DeviceModeFPGA DeviceMode = "fpga"
	// DeviceModeGPU represents 'gpu' device manager
	DeviceModeGPU DeviceMode = "gpu"
)
...
const (
	...
	defaultDriverImageName = "intel/cdi-driver"
	...
	DefaultDeviceMode = DeviceModeFPGA
)

var (
	// DefaultNodeSelector default node label used for node selection
	DefaultNodeSelector = map[string]string{"storage": "cdi"}
)
...
func (d *Deployment) EnsureDefaults(operatorImage string) error {
	...
	case DeviceModeFPGA, DeviceModeGPU:
	default:
...
func GetDeploymentCRDSchema() *apiextensions.JSONSchemaProps {
	return &apiextensions.JSONSchemaProps{
		Type:        "object",
		Description: "https://github.com/intel/cdi.git",
				...
				Properties: map[string]apiextensions.JSONSchemaProps{
					...
					"deviceMode": apiextensions.JSONSchemaProps{
						...
						Enum: []apiextensions.JSON{
							apiextensions.JSON{Raw: []byte("\"" + DeviceModeFPGA + "\"")},
							apiextensions.JSON{Raw: []byte("\"" + DeviceModeGPU + "\"")},
						},
					},
					"image": apiextensions.JSONSchemaProps{
						Type:        "string",
						Description: "CDI driver docker image",
					},
					...
					"registryCert": apiextensions.JSONSchemaProps{
						Type:        "string",
						Description: "Encoded cdi-registry certificate",
					},
					...
					"nodeControllerCert": apiextensions.JSONSchemaProps{
						Type:        "string",
						Description: "Encoded cdi-node-controller certificate",
					},
